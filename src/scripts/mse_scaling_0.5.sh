...
#SBATCH -o /n/home02/bostdiek/DarkMachines/src/scripts/logs/mse_scaling_0.5.out  #
#SBATCH -e /n/home02/bostdiek/DarkMachines/src/scripts/logs/mse_scaling_0.5.err  #

source activate bostdiek_darkmachines
cd /n/home02/bostdiek/DarkMachines/src/models
python train.py --show --batch_size 500 --decoder_width 256 --encoder_width 256 --show_number=5000 --total_masked_weight 0.5 
