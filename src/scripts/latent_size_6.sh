...
#SBATCH -o /n/home02/bostdiek/DarkMachines/src/scripts/logs/latentsize_6.out  #
#SBATCH -e /n/home02/bostdiek/DarkMachines/src/scripts/logs/latentsize_6.err  #

source activate bostdiek_darkmachines
cd /n/home02/bostdiek/DarkMachines/src/models
python train.py --show --batch_size 500 --epochs 20 --decoder_width 256 --encoder_width 256 --show_number=5000 --latent_size 6 --total_masked_weight 0.001 
