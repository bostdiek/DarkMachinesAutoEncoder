...
for Beta in [1e-3, 1]:
    for ClassPredWeight in [1, 10]:
        ...
        with open(fname, 'w') as fout:
            ...
            fout.write("#SBATCH -t 2-00:00          # Runtime in D-HH:MM, minimum of 10 minutes\n")
            ...
            fout.write(f"python train.py --dataset chan3 --train_only --num_workers 2 --batch_size 100 --epochs 50 --vae --beta={Beta} --decoder_width 256 --encoder_width 256 --class_pred_weight {ClassPredWeight} --show_number=5000 --latent_size {LatentSize} --total_masked_weight 0.0001 \n")
